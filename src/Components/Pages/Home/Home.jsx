    ...
    <div className={`border-solid border-[1px] border-black rounded-2xl mt-4`}>
      <div className="my-2.5 flex flex-col items-center gap-2">
        <img
          ...
          className="w-32 h-32"
        />
        <p className="font-bold text-lg leading-5 text-center h-[40px]">{props.title}</p>
...
const Home = () => {
  ...
  const { isLoading, data } = useProducts("Tất cả");
  useEffect(() => {
    if (dataSearched) {
      ...
      <div className="mt-12 mx-16">
        ...
        <div className="mt-10 border-solid	border-[1px] border-black rounded-2xl px-11 py-7">
          <div className="flex items-center gap-x-2">
            ...
            <p className="font-bold text-2xl text-[#eb5757]">Điện thoại nổi bật</p>
          </div>
